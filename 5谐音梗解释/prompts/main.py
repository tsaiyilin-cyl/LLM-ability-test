...
test_cases_en = {
    ...
    "data4": "Student A said to his roommate B, 'I think Shen Congwen must have been really passionate about science and engineering.' B asked, 'Why?' A replied, 'Don't you know he wrote a book called Border Town (边城)?' Please explain this pun.",
    "data5": "A asked B, 'Does Chongqing not have any must-eat snacks (必吃)?' B angrily said, 'How can you deprive them of their right to eat (鼻吃)?' Please explain this pun.",
    "data6": "Xiao Ming imitated Zhao Yun's majestic voice: 'I am (我奶) Zhao Zilong of Changshan!' His grandmother was surprised: 'Dear, I (我奶=我乃/我奶奶) have never hit anyone!' Please explain this pun.",
